...
Additionally, you validate your models using historical data provided by the short and long term forecast reports, assess the reliability of your data sources, and consider the potential variability and uncertainty in your forecasts.
...
A trusted intelligence analyst provided you with this short-term forecast reports related to the question:
{short_term_forecast}

An other trusted intelligence analyst provided you  long-term forecast reports related to the question:
{long_term_forecast}
...
3) **write down your reasoning/explanation** Clearly explain the factors that influenced your forecast, the data you considered, how the short and long term forecast reports impacted your result, how the provided sources in both reports helped you, but also the methods you used to arrive at your probability estimate.
